...
function plusSlides(e){showSlides(slideIndex+=e)}function currentSlide(e){showSlides(slideIndex=e)}function showSlides(e){var n,t=document.getElementsByClassName("slider__item"),l=document.getElementsByClassName("slider__toggle");for(e>t.length&&(slideIndex=1),e<1&&(slideIndex=t.length),n=0;n<t.length;n++)t[n].style.display="none";for(n=0;n<l.length;n++)l[n].className=l[n].className.replace(" active","");t[slideIndex-1].style.display="block",l[slideIndex-1].className+=" active"}var slideIndex=1;showSlides(slideIndex),function(){var e={navToggle:document.querySelector(".btn_mnu"),nav:document.querySelector(".nav__list"),doToggle:function(e){e.preventDefault(),this.navToggle.classList.toggle("active"),this.nav.classList.toggle("active")}};e.navToggle.addEventListener("click",function(n){e.doToggle(n)}),e.nav.addEventListener("click",function(n){e.doToggle(n)})}();var carouselOneByOne=new PureJSCarousel({carousel:"#carousel",slide:".stuff__items-carousel",oneByOne:!0,infinite:!0});AOS.init({once:!0});var goTopBtn=document.querySelector(".btn-top");window.addEventListener("scroll",trackScroll),goTopBtn.addEventListener("click",backToTop),function(){"use strict";function e(){var e=window.pageYOffset,n=document.documentElement.clientHeight;e>n&&t.classList.add("active"),e<n&&t.classList.remove("active")}function n(){window.pageYOffset>0&&(window.scrollBy(0,-80),setTimeout(n,0))}var t=document.querySelector(".btn-top");window.addEventListener("scroll",e),t.addEventListener("click",n)}();